...
const roadmapData = {
  ...
  "Artificiële Intelligentie & Smart-Functionaliteit": [
    ...
    { id: 47, title: "AI-Powered Risico-Identificatie", description: "Analyseert taakteksten op potentiële risicowoorden.", completed: true },
  ...
  "Notificaties & Communicatie": [
      ...
      { id: 90, title: "Notificatie \"Snooze\" Functionaliteit", description: "Stel een notificatie uit.", completed: true },
