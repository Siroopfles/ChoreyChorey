...
const roadmapData = {
  "Fundamenteel Taakbeheer": [
    ...
    { id: 5, title: "Taaktemplates", description: "Voor 'Wekelijkse Huis-Reset' of 'Onboarding Nieuwe Medewerker'.", completed: true },
  ...
  "Community & Gamification": [
    ...
    { id: 33, title: "Karma- & Bedanksysteem", description: "Stimuleer positieve interactie met een bedank-knop.", completed: true },
  ...
  "Het Webdashboard & Gebruikersinterface": [
      ...
      { id: 52, title: "Keyboard Shortcuts (Webdashboard)", description: "Gebruik sneltoetsen zoals Cmd/Ctrl+K voor efficiëntie.", completed: true },
      { id: 75, title: "Gebruikersprofielen", description: "Bekijk de statistieken en taken van een gebruiker.", completed: true },
      { id: 49, title: "Kalenderweergave", description: "Een kanaal als live Kanban-bord.", completed: true },
  ...
  "Integraties & API": [
    { id: 71, title: "Data Export (CSV)", description: "Migreer van/naar CSV, Trello, etc.", completed: true },
