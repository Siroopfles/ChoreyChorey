...
export const roadmapPhases: Phase[] = [
  ...
  },
  {
   ...
   {
    name: "Fase 4: Verfijning & Optimalisatie (Actief)",
    ...
    features: [
        ...
        { id: 4006, title: "Aanpasbare Dashboards", description: "Stel je eigen dashboard samen met een bibliotheek van widgets.", completed: false },
        { id: 4007, title: "Geavanceerde Terugkerende Taken", description: "Stel complexe herhalingen in, zoals 'elke laatste vrijdag van de maand'.", completed: false },
        { id: 4008, title: "Toegankelijkheidsverbeteringen (WCAG)", description: "Zorg ervoor dat de applicatie volledig voldoet aan WCAG 2.1 AA-normen.", completed: false },
        { id: 4009, title: "Persoonlijke Werk-uren", description: "Stel je werkuren in om workload-berekeningen en notificaties te verfijnen.", completed: false },
    ]
  },
  {
    name: "Fase 5: Geavanceerde Enterprise & Innovatie (Toekomst)",
    ...
    features: [
      { id: 5001, title: "Budgettering & Kostentracering", description: "Wijs budgetten toe aan projecten en houd de kosten per taak bij.", completed: false },
      { id: 5002, title: "Resource Management", description: "Geavanceerde capaciteitsplanning en workload-inzichten over langere periodes.", completed: false },
      { id: 5003, title: "Custom Fields", description: "Voeg eigen velden (tekst, getal, datum, dropdown) toe aan taken voor maximale flexibiliteit.", completed: false },
      ...
      { id: 5006, title: "Gast- / Klanttoegang", description: "Geef externe gebruikers beperkte, read-only toegang tot specifieke projecten of taken.", completed: false },
      { id: 5007, title: "IP Whitelisting", description: "Beperk toegang tot de organisatie tot specifieke IP-adressen voor extra beveiliging.", completed: false },
      ...
      { id: 5010, title: "AI Burnout Voorspelling", description: "Signaleert risico op overbelasting op basis van werkpatronen en taken.", completed: false },
      { id: 5011, title: "AI Automatische Status Updates", description: "Stelt statuswijzigingen voor op basis van gekoppelde commits, comments en activiteit.", completed: false },
      ...
      { id: 5013, title: "AI Project Coördinator", description: "Een AI-agent die basis follow-ups doet, vergaderingen plant en rapportages opstelt.", completed: false },
