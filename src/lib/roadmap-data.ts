...
export const roadmapData = {
    ...
    "Fundamenteel Taakbeheer (Verdieping)": [
      ...
      { id: 6, title: "'Blokkerende' status", description: "Maakt visueel duidelijk dat een taak geblokkeerd is en waarom.", completed: true },
    ...
    "Community, Gamification & HR": [
      ...
      { id: 31, title: "Mentorschap Programma", description: "Koppel ervaren gebruikers aan nieuwkomers.", completed: true },
      { id: 32, title: "Dynamische Leaderboards", description: "Op basis van specifieke tags, bv. \"Top Bug Fixer\".", completed: true },
      { id: 33, title: "Community-driven 'Chore of the Week'", description: "Een uitdagende taak voor iedereen.", completed: true },
      { id: 34, title: "'Virtuele 'Team Room'", description: "Een 2D/isometrische ruimte waar avatars van teamleden zijn.", completed: true },
      { id: 35, title: "User-Generated Content Challenges", description: "Bv. 'maak de beste taak-template'.", completed: true },
      { id: 36, title: "Project Post-Mortem Badges", description: "Badges voor succesvol afgeronde projecten.", completed: true },
      { id: 58, title: "'Help Wanted' Board", description: "Vraag om hulp bij specifieke taken.", completed: true },
      { id: 59, title: "Team-Based Challenges & Competities", description: "Stel doelen voor teams met een beloning.", completed: true },
      { id: 60, title: "Skill Endorsements", description: "Gebruikers kunnen elkaars vaardigheden onderschrijven.", completed: true },
      { id: 61, title: "Ideeënbus & Feature Request Voting", description: "Laat gebruikers meebeslissen over de toekomst van Chorey.", completed: true },
    ...
    "Het Webdashboard, UI & UX": [
      ...
      { id: 40, title: "'Multi-Window / Tab Support", description: "Ondersteuning voor meerdere vensters in de webapp.", completed: true },
      ...
      { id: 44, title: "Drag & Drop Taakcreatie vanuit bestanden", description: "Sleep bestanden om taken aan te maken.", completed: true },
      { id: 45, title: "Visuele Workflow Editor", description: "Bouw workflows met een drag-and-drop interface.", completed: true },
      ...
      { id: 69, title: "Offline Modus (PWA)", description: "Werk offline en synchroniseer later.", completed: true },
    ...
    "Notificaties & Communicatie": [
      ...
      { id: 66, title: "'Leesbevestiging' voor belangrijke comments of updates", description: "Zie wie een belangrijke update heeft gelezen.", completed: true },
    ...
    "Veiligheid, Compliance & Beheer": [
      ...
      { id: 70, title: "Sessie Management", description: "Zie en beëindig actieve login-sessies.", completed: true },
    ...
    "Analytics & Reporting": [
      ...
      { id: 76, title: "Gebruikersprestatie Dashboards", description: "Individueel en team.", completed: true },
