...
export const phase8: Phase = {
    ...
    features: [
      ...
      { id: 8008, title: "Camera Integratie voor Bijlagen", description: "Maak het mogelijk om direct vanuit de taakdetails een foto te maken met de camera van het apparaat en deze als bijlage toe te voegen. Ideaal voor het documenteren van bugs of fysieke werkzaamheden.", completed: false },
