...
export const phase8: Phase = {
    ...
    description: "Een naadloze en krachtige ervaring creëren voor gebruikers die onderweg zijn. Alle web-gebaseerde features zijn voltooid. Native-specifieke features staan hieronder apart vermeld.",
    features: [
      ...
      { id: 8007, title: "Mobiele Spraakcommando's", description: "Integreer de spraakherkenning direct in de mobiele app-interface, bijvoorbeeld via een microfoon-icoon in de zoekbalk, om taken handsfree te kunnen aanmaken of bewerken.", completed: true },
      ...
      { id: 8010, title: "QR Code Scanner voor Taken", description: "Associeer taken met een QR-code. Gebruikers kunnen dan de code scannen met de mobiele app om direct naar de betreffende taakdetails te navigeren, handig voor het beheren van fysieke objecten of locaties.", completed: true },
