...
export const phase9: Phase = {
  ...
  features: [
    { id: 9001, title: "Deelbare & In te sluiten Dashboards", description: "Genereer een veilige, read-only link naar een geconfigureerd dashboard. Deze link kan worden gedeeld met stakeholders die geen account hebben, of worden ingesloten (embed) in andere tools zoals Confluence of Notion.", completed: false },
    { id: 9002, title: "Geplande Rapporten via E-mail", description: "Configureer de rapportagebouwer om een specifiek rapport automatisch als PDF te genereren en te mailen op een vast schema (bv. elke maandagochtend) naar een lijst van ontvangers.", completed: false },
    { id: 9003, title: "Cycle & Lead Time Analyse", description: "Genereer grafieken die de doorlooptijd van taken visualiseren: de 'lead time' (van creatie tot voltooiing) en de 'cycle time' (van 'In Uitvoering' tot voltooiing). Dit helpt bij het identificeren van knelpunten in de workflow.", completed: false },
    { id: 9004, title: "Individuele Productiviteitsinzichten", description: "Een persoonlijk dashboard voor elke gebruiker met statistieken over voltooide taken, behaalde punten, focustijd (op basis van de timer), en grafieken die de meest productieve dagen en uren tonen.", completed: false },
